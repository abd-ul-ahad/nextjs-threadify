...
```bash
# npm
npm install next-threaded

# yarn
yarn add next-threaded

# pnpm
pnpm add next-threaded
```
...
```tsx
import { threaded, parallelMap } from "next-threaded";
...
```typescript
import { parallelMap } from "next-threaded";
...
```typescript
import { configureThreaded } from "next-threaded";
...
```typescript
import { getThreadedStats } from "next-threaded";
...
```typescript
import { destroyThreaded } from "next-threaded";
